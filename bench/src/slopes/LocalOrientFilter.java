...
public class LocalOrientFilter {
   ...
   */
  public void applyForNormalE(float[][] x, float[][] u1, float[][] u2) {
    int n2 = x.length;
    int n1 = x[0].length;
    ...
    zm.apply(0.01f,el);
    el = pow(el,_epow);
    el = div(1.0f,add(1.0f,pow(mul(_alpha,el),2.0f)));
    applyE(x,el,
      null,
      u1,u2,
      null,null,
   ...
   * @param u2 2nd component of normal vector.
   */
  public void applyForNormal(float[][] x, float[][] u1, float[][] u2, float[][] eu) {
    apply(x,
      eu,
      u1,u2,
      null,null,
   ...
   * @param el (eu-ev)/eu, a measure of linearity.
   */
  public void applyE(float[][] x, float[][] s,
    float[][] theta,
    float[][] u1, float[][] u2, 
    float[][] v1, float[][] v2,
    float[][] eu, float[][] ev, 
    float[][] el)
  {
    ...
    // Smoothed gradient products comprise the structure tensor.
    if (_lsfSmoother1!=null || _lsfSmoother2!=null) {
      float[][] h = (nt>3)?t[3]:new float[n2][n1];
      float[][][] gs = {g11,g22,g12};
      for (float[][] g:gs) {
        ...
        if (_lsfSmoother2!=null) {
          _lsfSmoother2.apply(_c2,s,h,g);
        } else {
          copy(h,g);
        }
      }
   ...
   */
  public void applyForNormalE(float[][][] x, 
   ...
   * @return structure tensors.
   */
  public EigenTensors3 applyForTensorsE(float[][][] x) {
    return applyForTensorsE(x,true);
  }
   ...
   * @return structure tensors.
   */
  public EigenTensors3 applyForTensorsE(float[][][] x, boolean compressed) {
    int n1 = x[0][0].length;
    int n2 = x[0].length;
    int n3 = x.length;
    ...
    float[][][] ep = new float[n3][n2][n1];
    float[][][] u1p = new float[n3][n2][n1];
    float[][][] u2p = new float[n3][n2][n1];
    float[][][] u3p = new float[n3][n2][n1];
    ZeroMask zm = new ZeroMask(ep);
    ...
    float[][][] ep, float[][][] el)
  {
    ...
    // Smoothed gradient products comprise the structure tensor.
    if (_lsfSmoother1!=null || _lsfSmoother2!=null || _lsfSmoother3!=null) {
      ...
      for (float[][][] g:gs) {
        ...
        if (_lsfSmoother3!=null) {
          _lsfSmoother3.apply(_c3,s,g,h);
          copy(h,g);
        }
      }
    }
  ...
  private float _c2;
  private float _c3;
  private float _epow = 6.0f;
  private float _alpha = 5.0f;
  ...
  private LocalSmoothingFilter _lsfSmoother1 = new LocalSmoothingFilter();
  private LocalSmoothingFilter _lsfSmoother2 = new LocalSmoothingFilter();
  private LocalSmoothingFilter _lsfSmoother3 = new LocalSmoothingFilter();
